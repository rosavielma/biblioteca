...
<div id="subdivisiones" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
            		...
            		<div class="modal-body">
            			<form action="../../consultas/subdivisiones/insertar.php" method="POST">
					<div>
					...
					<div>
					      	<label for="sub">Diviciones</label>
					          <select id="sub" class="form-control input-sm" name="diviciones" required> 
					          	<option value="0">Seleccione</option>
					          	<?php 
					          		require_once ('../../consultas/conexion.php');
